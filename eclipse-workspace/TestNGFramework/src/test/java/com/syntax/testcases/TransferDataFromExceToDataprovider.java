...
public class TransferDataFromExceToDataprovider extends BaseClass {
	...
	public void addEmployee(String fName, String mName, String lName, String location) throws InterruptedException {
		...
		CommonMethods.sendText(addEmp.empCheck, lName);
		CommonMethods.waitForElementBeClickable(addEmp.location, 20);
		CommonMethods.click(addEmp.location);
		CommonMethods.selectList(addEmp.locationList, location);
		CommonMethods.click(addEmp.employeeId);
	...
	public static Object[][] ReadVariant() throws IOException {
		String file_location = "src\\test\\resources\\TestDate\\Book 1.xlsx";
